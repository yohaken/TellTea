...
/** ฟอร์มโอนเข้า — ใช้ในบัญชี (เจ้าของ) */
export function TransferInModal({ createdBy, onClose, onSaved, onError }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form
          className="form-card module-entry-form transfer-in-form"
