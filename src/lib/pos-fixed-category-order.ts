...
const ALIASES: Record<string, string> = {
  ...
  "Signature Drinks เย็น, ปั่น": "Signature Drinks เย็น/ปั่น",
  "ชานมสดคราฟต์ เย็น, ปั่น": "ชานมสดคราฟต์ เย็น/ปั่น",
  "ชานม เย็น, ปั่น": "ชานม เย็น/ปั่น",
  "กาแฟ เย็น, ปั่น": "กาแฟ เย็น/ปั่น",
  "นม เย็น, ปั่น": "นม เย็น/ปั่น",
  "เบาเบากับน้ำเต้าหู้ เย็น, ปั่น": "เบาเบากับน้ำเต้าหู้ เย็น/ปั่น",
  "Signature Drinks (เย็น, ปั่น)": "Signature Drinks เย็น/ปั่น",
  "ชานมสดคราฟต์ (เย็น, ปั่น)": "ชานมสดคราฟต์ เย็น/ปั่น",
  "ชานม (เย็น, ปั่น)": "ชานม เย็น/ปั่น",
  "กาแฟ (เย็น, ปั่น)": "กาแฟ เย็น/ปั่น",
