...
export const TUNE_DESK_PROTOCOL: string[] = [
  `ระบบแชทชื่อ「${TUNE_DESK_NAME}」(Tune Desk) — ป๊อปอัปบน /vat-sales/`,
  "ตั้งชื่อตัวเองครั้งแรกในป๊อปอัป แล้วใช้ชื่อเดิมทุกครั้ง (จำในเครื่อง)",
  "พิมพ์สั้น กระชับ เป็นภาษาไทยหรืออังกฤษสั้นๆ",
  "ถามเฉพาะตอนติดจริงเรื่องตารางนำเข้า/ไฟล์/คอลัมน์ — อย่าแชทเล่น",
  `โพสต์คำถามแบบ Ask แล้วรอได้ไม่เกิน ${TUNE_DESK_DEFAULT_WAIT_SEC} วินาที`,
  "ถ้าป้าย mentor = ออฟไลน์ หรือหมดเวลารอ → ไปต่อเองทันที อย่ารอ · ช่องไม่ชัวร์ปล่อยว่าง",
  "อย่าสมมติว่ามีคนตอบเสมอ — แชทนี้เป็นทางเลือก ไม่ใช่บังคับทุกขั้นตอน",
  "อ่าน #vat-import-ai-notes ด้วย · ห้ามกดใช้เข้าเดือนจนกว่าคนจะสั่ง",
];
