...
export const DELIVERY_COL_INFO = {
  appSales:
    "ยอดขายแอพ = ยอดขายที่แพลตฟอร์มรายงาน (รวม VAT) · ใช้คิดภาษีขายเท่านั้น ไม่ใช่รายได้",
  transfer:
    "ยอดโอน = เงินเข้าบัญชีหลังแพลตฯ หัก GP แล้ว · เป็นรายได้ถึงร้าน / ฐานกำไร",
  gpFee:
    "คชจ.GP = ค่าบริการแพลตฟอร์ม (ไม่รวม VAT) · หักอยู่ในยอดโอนแล้ว · โชว์อ้างอิง ไม่หักซ้ำกำไร",
  purchaseVat:
    "VAT-ซื้อ = ภาษีซื้อจากบิลค่า GP · ไปหักภาษีขายใน D · ไม่ใช่เงินหักเพิ่มจากโอน",
} as const;

/** ป้ายบทบาทสั้นใต้หัวคอลัมน์ — อ่านชั้นบัญชีได้ทันที */
export const DELIVERY_COL_ROLE = {
  appSales: "→ VAT",
  transfer: "→ รายได้",
  gpFee: "อ้างอิง",
  purchaseVat: "→ D",
...
export const DELIVERY_SOURCE_GUIDE = {
  overview:
    "หน้าแหล่งนำเข้า: กล่อง AI เดียวรับแคปจอ ≤3 รูป → คัดแยก GB/SF/LM · ยังไม่ผสานงบ",
  grab: "Grab: แคปหน้าการเงิน→สรุปทั้งเดือน",
  lineman: "LINE MAN: แคปสรุป/เมล GP ประจำเดือน",
  shopee: "Shopee: แคปเมลสรุปเดือน (วันที่รายงาน)",
  sync: "รอบนี้ยังไม่ซิงก์เข้าตารางสรุป — ตรวจพรีวิวก่อน",
