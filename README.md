...
ตั้งค่าที่ **อื่นๆ → ตั้งค่าโมดูล → แจ้งเตือนเจ้าของ (LINE + ยอดต่ำ)**

- เกณฑ์เงินคงเหลือขั้นต่ำของพนักงาน (ป็อปอัป + Web Push เมื่อยอดเปลี่ยน)
- สรุปรายวันช่วงเช้าทาง LINE (ครั้งเดียวต่อวัน): ยอดคงเหลือ · แจ้งบิลรอชำระ · ยอดขายหน้าร้านวันก่อน · จำนวนสมาชิก
- ใส่ Channel access token + LINE User ID จาก [LINE Developers](https://developers.line.biz/console/) แล้วกดส่งทดสอบ
