...
เงื่อนไข sync: `inclusive` + VAT>0 + **ผู้ขาย** + **ในนาม** + `ใช้ขอคืนได้` · **เจ้าของเท่านั้น**

- [x] `reconcileExpenseVatInputInvoice` สร้าง/อัปเดต/ถอน
- [x] บังคับผู้ขาย + ชื่อในนาม (ไม่ใช้คำอธิบายแทนผู้ขาย)
- [x] ลบแถวบช. → ลบใบกำกับที่ลิงก์
- [x] เปลี่ยนสถานะไม่ขอคืน → ถอนลิงก์ตอนบันทึก
- [x] รับบิล: เตือนเช็คชื่อ / บอกว่าจะลิงก์หรือยัง
- [ ] รวมยอดกับ VAT เดือน play-safe — ยังห้ามรวมมือ
- [ ] กันบิลซ้ำข้าม ledger↔ownerBooks — รอบถัดไป
