...
**หน้า `/vat-sales/sources/` (build 595):**  
1. ตาราง「ยอดรวมเดือน (ผสานเข้างบทันที)」 — **ช่วงปิดงบต้นเดือนเปิดเดือนก่อน** (เช่น ส.ค. → ก.ค. 2569)  
2. บล็อก `#vat-sources-drive-slot` — เช็คลิสต์ F0–F5 · ซิงก์ Drive · ร่างยอด · ยืนยันลงตาราง · กล่องแยกแอพ  

คิวปิดงบเดือน 7: เชื่อม Drive → ซิงก์เมล/ไฟล์เดือน `2026-07` → ร่าง F4 → ยืนยัน F5 → ปิดงบที่ `/vat-sales/`
