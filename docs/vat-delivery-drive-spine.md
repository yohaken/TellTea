...
- ชั้นเดือน: `YYYY-MM` จาก **ช่วงในเนื้อเมล** (`วันที่รายงาน: A ถึง B` / สรุปเดือน) ก่อน · แล้วค่อยหัวข้อ · แล้ววันรับเมล (Bangkok)
- เคส Shopee: หัวข้อ `รายงานการโอน…2026-08-01` แต่เนื้อ `ยอดขายสะสมประจำเดือน / 2026-07-01 ถึง 2026-07-31` → โฟลเดอร์ `2026-07` · แท็ก `sf-สรุปเดือน`
- คัดแยก: heuristic ที่ sync + ปุ่ม「คัดแยกเดือน (เนื้อ+Gemini)」→ `vatMailAiClassifyPeriod`
...
**หน้า `/vat-sales/sources/` (build 598):**  
1. ตาราง「ยอดรวมเดือน」— ช่วงปิดงบต้นเดือนเปิดเดือนก่อน (ส.ค. → ก.ค.)  
2. Drive slot — ย้อนเมล 120 วัน · คาบเกี่ยวขอบเดือน · **คัดแยกเดือนจากเนื้อ/Gemini** · **ตารางรายวัน 4 คอลัมน์** (ยอดขายแอพ · ยอดโอน · คชจ.GP · VAT-ซื้อ)  

**หลัก owner:** ไม่กรอกเอง — ระบบ/AI เติม · owner **ซุ่มตรวจ** แล้วกด F5  

คิวปิดงบเดือน 7: เชื่อม Drive → ซิงก์เมล → **คัดแยกเดือน** → ซิงก์ไฟล์ Drive → **ระบบเติมยอด F4** (สรุปเดือนถ้ามี · ไม่มีแล้วใช้รายวัน) → ซุ่มตรวจ → ยืนยัน F5 → ปิดงบ
