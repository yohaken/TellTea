...
**หน้า `/vat-sales/sources/` (build 601):**  
1. ตาราง「ยอดรวมเดือน」— ช่วงปิดงบต้นเดือนเปิดเดือนก่อน (ส.ค. → ก.ค.)  
2. **รางแนวนอนต่อแอพ** (ไฟล์ | เช็คลิสต์ความถูกต้อง | ตารางรายวัน+ยอดเดือน) · กอง Drive รวม · กลุ่ม A สรุปเดือน / B รายวัน  


**หลัก owner:** ไม่กรอกเอง — ระบบ/AI เติม · owner **ซุ่มตรวจ** แล้วกด F5  

คิวปิดงบเดือน 7: เชื่อม Drive → ซิงก์เมล → **คัดแยกเดือน** → **ซิงก์ไฟล์ → กองแอพ** → ระบบเติม F4 → ซุ่มตรวจ → F5
...
2. กด **ซิงก์เมล** แล้ว **ซิงก์ไฟล์ → กองแอพ**  
