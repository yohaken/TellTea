...
**หน้า `/vat-sales/sources/` เริ่มใหม่ (build 589):** ล้าง UI ศึกษา/ข้อเสนอ  
เหลือกรอกยอด + ส่งออกเข้างบรูปแบบเดิม + Gmail เชื่อม/ซิงก์

**ช่องว่างด้านล่าง (แสดงจริง):** `#vat-sources-drive-slot`  
ตารางแอพ/เดือนสถานะ「ว่าง」+ เช็ค F0–F3 + handoff `#vat-sources-drive-handoff`  
→ เอเจนถัดไปเติมรายการไฟล์จริงที่นี่
