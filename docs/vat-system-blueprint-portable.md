...
> **อัปเดต 2026-07-28:** แนวคิดหลักเปลี่ยนเป็น **VAT รายเดือน Play-Safe** — ดู `docs/vat-monthly-play-safe.md`  
> Blueprint ด้านล่างเป็นสเปกระบบรายวัน (P1–P7) ที่ถูกแทนที่จากทางใช้งานหลักแล้ว  
> **ไม่ผูก Excel** · **owner-only ทั้งก้อน**
