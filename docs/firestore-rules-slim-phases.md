...
- [x] Logout → login อีเมล+เบอร์
- [x] บัญชี: มีรายการ + ยอดคงเหลือ (ไม่มี “สิทธิ์ไม่พอ”) — 4.854
- [x] ผลิต / ชง / จ่าย / เช็ค / คลัง: โหลดได้
- [x] งาน / อื่นๆ: โหลดได้
- [ ] Owner Google: โอนเข้า / สมาชิก ยังใช้ได้ (ยังไม่เทสในรอบนี้)

**เกณฑ์ผ่าน:** เป้เปิดบัญชีแล้วเห็นข้อมูลจริง ไม่ขึ้น Missing permissions ✅ 2026-08-28
