...
4. **หน้าต่างเจ้าของ** — `/pos-sales/` รายงานยอดขาย + แท็บ **จัดการ Pos** (เครื่อง / สลิป / เมนู)
...
- เจ้าของตั้งเมนู / เครื่อง / สลิปจาก `/pos-sales/?tab=manage` (จัดการ Pos) · แท็บเล็ตแก้สลิปได้ที่ `/pos/settings/`
