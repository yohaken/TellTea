...
อัปเดต: **1.14.13** (ใบเสร็จ) · ship ปัจจุบัน **1.14.79** (เคย ship 1.14.42) · `APP_BUILD` 395 · `POS_BUILD` 131 · `versionCode` 102  
...
- [x] bold ESC/POS บนชื่อรายการ (+ x2+ option) — 1.14.79
