...
อัปเดต: **1.14.13** (ใบเสร็จ) · ship ปัจจุบัน **1.14.80** (เคย ship 1.14.42) · `APP_BUILD` 407 · `POS_BUILD` 132 · `versionCode` 103  
...
- [x] ซิงก์พลาด/ออฟไลน์: พิมพ์เลขชั่วคราว `#รอส่ง-XXXXXX` (web formatPendingBillNo)
