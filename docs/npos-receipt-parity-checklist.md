...
อัปเดต: **1.14.13** (ใบเสร็จ) · ship ปัจจุบัน **1.14.104** (พิมพ์เร็วท้องถิ่น) · `APP_BUILD` 548 · `POS_BUILD` 159 · `versionCode` 127  
...
### R3 จังหวะพิมพ์ (ไม่เสียกระดาษซ้ำ / ไม่ทิ้งลูกค้า) — **1.14.104** เร็วสุด
