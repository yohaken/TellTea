...
อัปเดต: **152** · vc **152** (ชื่อสั้น = versionCode · OTA ใช้เฉพาะเลขโค้ด)
...
- `versionName` = ตัวเลขเดียวกับ `versionCode` (เช่น `"152"`) — สั้น อ่านง่ายบนเครื่อง
...
## สไลด์ vc 152
1. พิมพ์ให้แต้มข้างสมาชิก (ชำระ · สมาชิก · พิมพ์ให้แต้ม · บันทึก)

## สไลด์ vc 151
1. ปุ่มพิมพ์ให้แต้มชัดขึ้น (แถบเต็มเหนือชำระ · ไม่ต้องมีบิล · โชว์คงเหลือ)

## สไลด์ vc 150
1. ปุ่มให้แต้มบนจอขาย (QR ของขวัญ 1 แต้ม · โควต้าต่อวัน)

## สไลด์ vc 149
1. ส่งภาพสลิปกลับหลังร้าน (หลังพิมพ์บิล)

## สไลด์ vc 148
1. โลโก้ร้านบนใบเสร็จ (จากหลังร้าน · เปลี่ยนรูปไม่ต้องอัป APK)

## สไลด์ vc 147
1. สลิปโชว์แต้มบิลนี้แถวยอดสุทธิ (+X)

## สไลด์ vc 146
1. สลิปบอกวิธีใช้แต้มใต้ QR (1แต้ม=ลด1฿ · ครั้งหน้าบอกเบอร์)
