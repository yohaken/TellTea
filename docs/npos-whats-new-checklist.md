...
อัปเดต: **145** · vc **145** (ชื่อสั้น = versionCode · OTA ใช้เฉพาะเลขโค้ด)
...
- `versionName` = ตัวเลขเดียวกับ `versionCode` (เช่น `"145"`) — สั้น อ่านง่ายบนเครื่อง
...
## สไลด์ vc 145
1. สลิปเต็มแผ่นแบบภาพ (576px / 80mm)
