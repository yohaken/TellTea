...
### งานย่อ
- [ ] O3.1 แหล่งความจริง `menuVersion` (bump ทุกครั้งที่บันทึกเมนู BO + FoodStory apply)
- [ ] O3.2 ส่ง version ใน heartbeat หรือ `nposShopSettings` / เมนู snapshot
- [ ] O3.3 Native เทียบ local → `reloadMenu(true)` เมื่อเปลี่ยน
- [ ] O3.4 Throttle ไม่รัว (เช่น อย่างน้อย 30 วิ ต่อครั้ง)
- [ ] O3.5 (ทางเลือก) ปุ่มรีเฟรชมือใน ▦ เป็นสำรอง
- [ ] O3.6 Gate + คนเทส
...
## O4 — เสียงพูดรับเงิน / ทอน

**ปัญหา:** มองแถบทอนอย่างเดียว · มือยุ่งอาจพลาดตัวเลข  
**เป้า:** พูดไทยสั้น «รับมา X บาท ทอน Y บาท» หลังขายสดที่มีทอน  
**วิธี:** Android `TextToSpeech` + `th_TH` · สวิตช์เปิด/ปิดในตั้งค่า · ไม่ใช้ cloud เป็นหลัก

เช็คลิส: [npos-payment-voice-checklist.md](./npos-payment-voice-checklist.md)

### งานย่อ
- [ ] O4.1 helper `PaymentVoice` (init / speak / shutdown)
- [ ] O4.2 เรียกตอน `onLocalSaved` ขายสด (รับ + ทอน)
- [ ] O4.3 ตั้งค่าเปิด/ปิด + ค่าเริ่มต้นเปิด
- [ ] O4.4 ไม่มีเสียงไทย → เงียบหรือบี๊บสั้น (ไม่ครASH)
- [ ] O4.5 Gate + คนเทสบน SUNMI จริง
