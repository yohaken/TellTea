...
อัปเดต: **O3+O4 ship 1.14.88** · อ้างอิง `/pos-sales` + nPos 1.14.88  
...
## O3 — เมนูซิงก์ตอนแอปค้าง · **ship 1.14.88**
...
## O4 — เสียงพูดรับเงิน / ทอน · **ship 1.14.88**

**ปัญหา:** มองแถบทอนอย่างเดียว · มือยุ่งอาจพลาดตัวเลข  
**เป้า:** พูดไทยสั้น «รับมา X บาท ทอน Y บาท» หลังขายสดที่มีทอน  
**วิธี:** Android `TextToSpeech` + `th_TH` · สวิตช์เปิด/ปิดในตั้งค่า · ไม่ใช้ cloud เป็นหลัก · **ไม่ fallback อังกฤษ**

เช็คลิส: [npos-payment-voice-checklist.md](./npos-payment-voice-checklist.md)

### งานย่อ
- [x] O4.1 helper `PaymentVoice` (init / speak / shutdown)
- [x] O4.2 เรียกตอน `onLocalSaved` ขายสด (รับ + ทอน)
- [x] O4.3 ตั้งค่าเปิด/ปิด + ค่าเริ่มต้นเปิด
- [x] O4.4 ไม่มีเสียงไทย → เงียบ (ไม่ครASH · ไม่พูดภาษาอื่น)
- [x] O4.5 Gate · คนเทสบน SUNMI จริงค้าง
