...
อัปเดต: **1.14.84** · `versionCode` 107 · `APP_BUILD` 446 · `POS_BUILD` 136
...
| **เด้งจนกว่าจะรับ** | **1.14.84** — สั่งแคปจาก BO / หลังอัปเดต → ถ้าไม่รับ จะเด้งซ้ำทุก ~2.5 วิ (ไม่ซ้อน dialog) จนกว่าจะกดอนุญาต |
...
## คนเทสเคาน์เตอร์
1. อัปเป็น **1.14.84** → เด้งขอแชร์หน้าจอ → กดอนุญาต
