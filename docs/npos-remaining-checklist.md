...
อัปเดต: **1.14.17** ตัดช่องทางเคาน์เตอร์ + แก้ e2e nav/menu ให้ deploy ผ่าน  
...
- [x] **Cut C1–C4** ตัดช่องทางเคาน์เตอร์ → หลังร้าน/เว็บ BO (**1.14.17**)
- [x] จิ้มเมนู → จ่าย → ใบเสร็จ → รีเซ็ต · ลิ้นชักตอนสด

## คิวถัดไป (เฟสก่อนหน้าที่ยังไม่ทำ)
| เฟส | โฟกัส | สถานะ | ทำไมค้าง |
|-----|--------|--------|----------|
| **Cut C1–C5** | ตัดทางเข้าหลังร้านจากเคาน์เตอร์ | ✅ C1–C4 | **1.14.17** · ค้างคนเทส C5 |
...
## คู่ขนานได้
- [x] **Cut C1–C4** ตัดช่องทางเคาน์เตอร์ → หลังร้าน (**1.14.17**)
