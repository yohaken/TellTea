...
- [x] **O3 menuVersion sync** heartbeat → reload เมนูตอน Sell ค้าง + ▦ รีเฟรช (**1.14.88**) · [npos-menu-version-sync-checklist](./npos-menu-version-sync-checklist.md)
- [x] **O4 เสียงพูดรับ/ทอน** TTS ไทย + สวิตช์ตั้งค่า · ไม่ fallback อังกฤษ (**1.14.88**) · [npos-payment-voice-checklist](./npos-payment-voice-checklist.md)
