...
อัปเดต: **1.14.104** + แผน **Exclusive seat S1–S4** · friction F0–F5  
...
## ทำแล้ว
- [x] **Print fast-local** พิมพ์ทันทีหลังบันทึกในเครื่อง · ซิงก์พื้นหลัง (**1.14.104**) · [npos-print-fast-local-phases](./npos-print-fast-local-phases.md)
