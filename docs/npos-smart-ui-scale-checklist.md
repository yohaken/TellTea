...
อัปเดต: **1.14.71** · `APP_BUILD` 356 · `POS_BUILD` 123
...
| 7 | แป้นเงินสดล้นจอ (D2s) | `padKeyMinPxForChrome` + `fitCardToWindow` · ไม่ซ้อน ScrollView |
| 8 | แป้นเปิดกะ/ปิดกะ/เคลมใหญ่เกิน | `padAmountMinPx` + CHROME_STANDARD/FLOAT_NOTE/CLAIM (**1.14.71**) |
| 9 | หลังอัปควรเห็น popup | ขึ้น **1.14.71** → เครื่องที่ยังเก่ากว่าจะได้ popup อัปเดต |
