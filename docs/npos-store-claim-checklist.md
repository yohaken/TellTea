...
- [x] A5 owner save ต้อง sync Firebase (ไม่เงียบ) · cloud ใหม่กว่าชนะ localStorage · native reload ตั้งค่าร้านตอน onResume · ใบเสร็จไม่ hardcode ที่อยู่ถ้าค่าว่าง (**1.14.38**)
