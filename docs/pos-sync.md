...
7. **ปิดรอบ (POS 29+)** — ปิดบนเครื่องทันทีหลังเช็คคิว; ส่ง Firestore เบื้องหลังมี timeout — **ห้ามค้างปุ่ม "กำลังทำ..."**
...
|----------|-----------|-----------|
| ขาย | สำเร็จทันที + outbox | flush เบื้องหลังเมื่อออนไลน์ |
| เปิดกะ | เปิดทันที | persist เบื้องหลัง |
| ปิดกะ | ปิดทันที (ถ้าว่างคิว) | flush ≤8s แล้ว persist close เบื้องหลัง |
| เมนู | cache ก่อน | subscribe อัปเดตเงียบ |
