...
อัปเดต: **1.14.91** · MenuAdmin CRUD+รูป+ตัวเลือก+ราคา · กดค้างของหมด · แป้นเงินสด/เปิดกะ/ปิดกะ/เคลม · **ห้าม** `AlertDialog.setItems`
...
- **จัดการเมนู** — `MenuAdminActivity` ตาราง + ชิปแท็บ · กดค้างกริดขายชีทปุ่มใหญ่ (**1.14.91**)
