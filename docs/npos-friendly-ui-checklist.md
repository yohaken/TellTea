...
อัปเดต: **1.14.36** · Prompt + ปุ่มสั้น (ตั้งค่า/เข้างาน) · แถวยาวหน้าขาย
...
6. สีแบรนด์: ส้ม `#E85D24` · หมึก `#1A2E24` · พื้น `#F7F7F5` (`colors.xml`)
...
- หน้าขาย (แถวจ่าย/ส่วนลด/พักบิล + ไอคอน)  
- ใบเสร็จ · กะ · เปิด/ปิดกะ · diagnose  
- แถบซ้าย / หัวบาร์ขาย · จอลูกค้า  
