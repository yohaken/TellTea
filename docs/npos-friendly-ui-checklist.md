...
อัปเดต: **1.14.90** · จัดการเมนู Native (MenuAdmin) + กดค้างของหมด · แป้นเงินสด/เปิดกะ/ปิดกะ/เคลม fit-to-window · **ห้าม** `AlertDialog.setItems` รายการบาง
...
- **จัดการเมนู** — `MenuAdminActivity` ตาราง + ชิปแท็บ · กดค้างกริดขายชีทปุ่มใหญ่ (**1.14.90**)
